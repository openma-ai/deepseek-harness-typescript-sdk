/**
 * Teardown ladder for the runtime subprocess: stdin EOF (cooperative
 * quiesce), then SIGTERM, then SIGKILL, resolving only after the process has
 * actually exited. Port of the in-repo `@deepseek-ai/dsh-sdk-client` dispose
 * module.
 *
 * @module @openma/deepseek-harness-sdk/dispose
 */
