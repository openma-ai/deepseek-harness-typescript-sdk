 ...
 * notification. Malformed lines are ignored; handler failures become error
 * frames. Port of the in-repo `@deepseek-ai/dsh-sdk-protocol` transport.
 *
 * @module @openma/deepseek-harness-sdk/transport
 */
...
/**
 * Outbound request and notification surface shared by the runtime server and
 * SDK clients.
 */
